...
![配置AI ](icons/AI1.png)![按CTRL+ALT+.](icons/AI2.png)![代码补全对比](icons/AI5.png)



## 中文

一个为SAP ABAP开发者打造的Eclipse AI代码补全插件。基于大语言模型（LLM），追求极致隐私与数据安全，可使用本地LLM,用于企业内部使用，防止企业代码上传到互联网，以保证代码的保密安全，在编写ABAP代码时提供智能的代码建议和自动补全功能。
### 代码补全TOKEN说明
- ** 1.经测试，在只使用当前程序或者当前打开的代码页参考时消耗的TOKEN数量很小，一般在几百TOKEN，如以1000TOKEN计，而DEEPSEEK百万TOKEN 0.04元计，那0.04元可代码补全1000次(输出很少可忽略), 1元可代码补全25000次,这足够用了，
- ** 2.也可以申请一些免费的模型使用，我测试时使用https://agnes-ai.cn/的免费模型agnes-2.5-flash也很好用·
### 比Copilot的优势
- **✅ 本地LLM支持** : 可使用本地LLM,用于企业内部使用，防止企业代码上传到互联网，以保证代码的保密安全。
- **✅ 完全开源，企业使用免费** : 该插件完全开源，企业使用免费，无需支付任何费用，不用当心代码安全问题，使用得更安心。
